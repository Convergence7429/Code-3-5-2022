...
public class Shooter {
    ...
    final static float horizontalDistanceFromLimelightToShooter = horizontalDistanceFromFrontOfRobotToLimelight - horizontalDistanceFromFrontOfRobotToShooter;
    ...
    public double dumpShotSpeed = 0.42;
    ...
    public boolean centerRobotOnTarget() {
        double xAngle = NetworkTableInstance.getDefault().getTable("limelight").getEntry("tx").getDouble(0.0) - 2.0;
    ...
    public void shoot() {
        ...
        if (shooting && !dumpShot) {
            ...
            if (Math.abs(calculatedAngle - tempAngle) > 0.004) {
                ...
                if ((masterShooterMotor.getSelectedSensorVelocity() > (shooterWheelLinearVelocityToMotorVelocity(calculatedVelocity) * 1.0145)) && setHoodYet) {
    ...
    public void dumpShot() { // 92 inches according to distance method
        ...
        if (dumpShot && !shooting) {
            ...
            if ((masterShooterMotor.getSelectedSensorVelocity() > (dumpShotSpeed * 22068.97 * 1.0145)) && setHoodYet) {
                Robot.intake.indexerMotor.set(-0.4);
            } else {
                Robot.intake.indexerMotor.set(0.0);
            }
